...
export default {
  ...
  mounted() {
    let menuContainer = document.querySelector(".nav-wrapper");
    let menuContainerInner = document.querySelector(".nav-bar-inner");
    window.onscroll = function () {
      if (window.pageYOffset >= 2) {
        menuContainer.classList.add("menu-black-bg");
        menuContainerInner.classList.add("menu-black-border");
      } else {
        menuContainer.classList.remove("menu-black-bg");
        menuContainerInner.classList.remove("menu-black-border");
      }
    };
  },
  computed: {
